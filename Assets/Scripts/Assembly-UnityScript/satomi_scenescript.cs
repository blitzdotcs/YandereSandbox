...
[Serializable]
public class satomi_scenescript : MonoBehaviour
{
	public GameObject animTest;

	public GUISkin guiSkin;

	public satomi_viewscript viewCam;
	...
	public satomi_scenescript()
	{
		...
		facialMatName = "f05_face_00";
		viewerResourcesPath = "Satomi";
	...
	public virtual void Start()
	{
		...
		viewCam = (satomi_viewscript)GameObject.Find("Main Camera").GetComponent("satomi_viewscript");
