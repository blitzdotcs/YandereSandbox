	...
	public abstract class NavGraph
	{
		...
		public virtual Color NodeColor(GraphNode node, PathHandler data)
		{
			...
			case GraphDebugMode.Penalty:
				result = Color.Lerp(AstarColor.ConnectionLowLerp, AstarColor.ConnectionHighLerp, (float)node.Penalty / AstarPath.active.debugRoof);
				flag = true;
				break;
			...
			if (!flag)
			{
				...
				case GraphDebugMode.G:
					result = Color.Lerp(AstarColor.ConnectionLowLerp, AstarColor.ConnectionHighLerp, (float)pathNode.G / AstarPath.active.debugRoof);
					break;
				case GraphDebugMode.H:
					result = Color.Lerp(AstarColor.ConnectionLowLerp, AstarColor.ConnectionHighLerp, (float)pathNode.H / AstarPath.active.debugRoof);
					break;
				case GraphDebugMode.F:
					result = Color.Lerp(AstarColor.ConnectionLowLerp, AstarColor.ConnectionHighLerp, (float)pathNode.F / AstarPath.active.debugRoof);
					break;
				}
			}
			result.a *= 0.5f;
