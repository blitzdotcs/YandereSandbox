...
public class AstarDebugger : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (Application.isPlaying)
		{
			...
			graph[num3].fps = ((!(Time.deltaTime < float.Epsilon)) ? (1f / Time.deltaTime) : 0f);
		...
		Matrix4x4 m = Matrix4x4.TRS(new Vector3((cam.pixelWidth - graphWidth) / 2f, graphOffset, 1f), Quaternion.identity, new Vector3(graphWidth, graphHeight, 1f));
