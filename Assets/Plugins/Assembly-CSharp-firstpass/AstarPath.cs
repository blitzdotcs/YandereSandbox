...
public class AstarPath : MonoBehaviour
{
	...
	public void FloodFill(GraphNode seed, uint area)
	{
		if (area > 65535)
		{
			Debug.LogError("Too high area index - The maximum area index is " + 65535u);
			return;
		}
		if (area < 0)
		{
	...
	public void FloodFill()
	{
		...
		if (warnAboutAreas)
		{
			Debug.LogError("Too many areas - The maximum number of areas is " + 65535u + ". Try raising the A* Inspector -> Settings -> Min Area Size value. Enable the optimization ASTAR_MORE_AREAS under the Optimizations tab.");
		}
